...
/**
 * Provides the base implementation for the permission template local service.
 *
 * <p>
 ...
 * @see com.liferay.permission.template.service.impl.PermissionTemplateLocalServiceImpl
 * @generated
 */
public abstract class PermissionTemplateLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   PermissionTemplateLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PermissionTemplateLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PermissionTemplateLocalServiceUtil</code>.
	 */
	...
	public PermissionTemplate createPermissionTemplate(
		...
		return permissionTemplatePersistence.create(permissionTemplateId);
	}
	...
	public PermissionTemplate deletePermissionTemplate(
		...
		return permissionTemplatePersistence.remove(permissionTemplateId);
	}
	...
	public PermissionTemplate deletePermissionTemplate(
		...
		return permissionTemplatePersistence.remove(permissionTemplate);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return permissionTemplatePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PermissionTemplate.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return permissionTemplatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return permissionTemplatePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return permissionTemplatePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public PermissionTemplate fetchPermissionTemplate(
		...
		return permissionTemplatePersistence.fetchByPrimaryKey(
	...
	public PermissionTemplate getPermissionTemplate(long permissionTemplateId)
		...
		return permissionTemplatePersistence.findByPrimaryKey(
			permissionTemplateId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(PermissionTemplate.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(PermissionTemplate.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return permissionTemplatePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement PermissionTemplateLocalServiceImpl#deletePermissionTemplate(PermissionTemplate) to avoid orphaned data");
		}

		return permissionTemplateLocalService.deletePermissionTemplate(
			(PermissionTemplate)persistedModel);
	}

	@Override
	public BasePersistence<PermissionTemplate> getBasePersistence() {
		return permissionTemplatePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return permissionTemplatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<PermissionTemplate> getPermissionTemplates(int start, int end) {
		return permissionTemplatePersistence.findAll(start, end);
	}
	...
	public int getPermissionTemplatesCount() {
		return permissionTemplatePersistence.countAll();
	}
	...
	protected void deactivate() {
		PermissionTemplateLocalServiceUtil.setService(null);
	}

	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PermissionTemplateLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		permissionTemplateLocalService =
			(PermissionTemplateLocalService)aopProxy;

		PermissionTemplateLocalServiceUtil.setService(
			permissionTemplateLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PermissionTemplateLocalService.class.getName();
	}
	...
	public <R, E extends Throwable> R updateWithUnsafeFunction(
		...
		return updateUnsafeFunction.apply(permissionTemplatePersistence);
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				permissionTemplatePersistence.getDataSource();
	...
	protected PermissionTemplateLocalService permissionTemplateLocalService;

	@Reference
	protected PermissionTemplatePersistence permissionTemplatePersistence;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PermissionTemplateLocalServiceBaseImpl.class);
