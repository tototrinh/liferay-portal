 ...
 */
public class NoSuchPermissionPropagationEntryException extends NoSuchModelException {
	...
	public NoSuchPermissionPropagationEntryException(String msg, Throwable throwable) {
		super(msg, throwable);
	}
