...
/**
 * Provides the local service interface for PermissionPropagationEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PermissionPropagationEntryLocalServiceUtil
 * @generated
 */
@CTAware
@ProviderType
...
public interface PermissionPropagationEntryLocalService
	extends BaseLocalService, CTService<PermissionPropagationEntry>,
